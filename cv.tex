...
% \textbf{Auto-Transcribe} \hfill May 2023 -- Aug 2023 \\
% \begin{zitemize}
%     \item Developed a pipeline to automatically transcribe videos using \proglang{Demucs} for stem separation and 
%     \proglang{Whisper} for speech recognition. Transcode and slice with \proglang{FFmpeg} and \proglang{torchaudio}.
%     Developed a fontend with \proglang{Gradio} to search, preview and export sentence audios within 1 second.
% \end{zitemize}
